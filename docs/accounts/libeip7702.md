...
The keccak256 of runtime code for `EIP7702Proxy.sol` with exact compilation settings,   
...
The length of the runtime code for `EIP7702Proxy.sol` with exact compilation settings,   
with immutables zeroized and without the CBOR metadata.
