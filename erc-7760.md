...
#### Minimal ERC-1967 transparent upgradeable proxy (20-byte factory address I-variant)
...
#### Minimal ERC-1967 transparent upgradeable proxy (14-byte factory address I-variant)
...
#### Minimal ERC-1967 UUPS proxy (regular variant)
...
#### Minimal ERC-1967 beacon proxy (regular variant)
...
#### Minimal ERC-1967 transparent upgradeable proxy implementation (regular variant)
...
#### Minimal ERC-1967 UUPS proxy implementation (regular variant)
...
#### Minimal ERC-1967 beacon proxy implementation (regular variant)
