...
using BLS for Fp global;
using BLS for Fp2 global;
using BLS for G1Point global;
using BLS for G2Point global;

/// @notice BLS wrapper.
/// @author Solady (https://github.com/vectorized/solady/blob/main/src/utils/g/BLS.sol)
