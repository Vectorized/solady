...
contract Timelock is ERC7821, EnumerableRoles {
    ...
    /// Not fully watertight, but in the rare case where `msg.sender` or `tx.origin` are
    /// untrusted and abused to frontrun, `initialize` will revert on reinitialization,
